...
import PredictionsMine from "./11_TimeDoorToGate.screen";
...
const styles = StyleSheet.create({
  ...
  return (
    <Tab.Navigator screenOptions={{ tabBarStyle: { backgroundColor: '#b3b0a1', borderTopWidth: 0, height: 60, marginBottom: -19.5 }, tabBarShowLabel: false }}>
        ...
        <Tab.Screen name="My Predictions" component={PredictionsMine} options={{ tabBarIcon: ({ color, size }) => (
            <Text style={styles.navText}>My Predictions</Text>
            ), headerShown: false,
        }} />

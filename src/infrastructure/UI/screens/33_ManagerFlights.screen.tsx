...
const styles = StyleSheet.create({
  ...
  return (
    <Tab.Navigator screenOptions={{ tabBarStyle: { backgroundColor: '#b3b0a1', borderTopWidth: 0, height: 60, marginBottom: -19.5 }, tabBarShowLabel: false }}>
        ...
        <Tab.Screen name="Information" component={FlightsInformation} options={{ tabBarIcon: ({ color, size }) => (
            <Text style={styles.navText}>Information</Text>
            ), headerShown: false,
        }} />

        <Tab.Screen name="My Flights" component={FlightsMine} options={{ tabBarIcon: ({ color, size }) => (
            <Text style={styles.navText}>My Flights</Text>
            ), headerShown: false,
        }} />

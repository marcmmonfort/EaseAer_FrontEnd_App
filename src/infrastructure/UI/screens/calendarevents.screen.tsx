import { View, Text, ImageBackground, StyleSheet, TouchableOpacity, Image, FlatList, Platform } from "react-native";
    ...
    <ImageBackground source={require('../../../../assets/visualcontent/background_8.png')} style={styles.backgroundImage}>
      <SafeAreaView style={styles.container}>
        <View style={styles.buttonsCalendar}>
          ...
          >
            <Text style={styles.textForButtons}>Own</Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <Text style={styles.textForButtons}>Friends</Text>
          </TouchableOpacity>
        </View>
